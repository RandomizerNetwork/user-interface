        ...
        <section className="cta-section mb-5">
            <div className="container">
                <div className="cta-wrapper item-layer mt-5">
                    <div className="cta-item px-4 px-sm-5 pt-4 pt-sm-5 pt-lg-0" style={{ "backgroundImage": "url(assets/images/cta/bg_purple.jpg)" }}>
                        <div className="row align-items-center">
                            <div className="col-lg-6">
                                <div className="cta-content">
                                    ...
                                    <p className="mb-4">
                                        We are building the most trustless customizable DAO DeFi Launchpad. We are building a No-Code customizable Chainlink multi-chain DAO & NFT's distribution manager. Join the play to earn revolution!
                                    </p>
