...
// 7 days staking 
// totalReward 110001000000000000000000 -> 110.001 Tokens
// rate 9
// lockDuration 168 

// 7 days staking - 110001000000000000000000 -> 110.001 Tokens
// 7 days staking - 110001000000000000000000 -> 110.001 Tokens
// 7 days staking - 110001000000000000000000 -> 110.001 Tokens
...
contract Staking is Ownable {
    ...
    // "7 days staking", TOKEN_ADDRESS, 9, 168
    // "7 days staking", TOKEN_ADDRESS, 9, 1
    constructor(
        string memory name_,
    ...
    function _withdraw(address from) private returns (bool) {
        ...
        console.log("reward = %s , rewardBalance = %s", reward, rewardBalance);
